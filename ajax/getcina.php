...
if(!$conn = connectDB()) {echo errorConnectDB(); exit();}
    ...
    $sql = "SELECT t.*, blogB.content as rife FROM
            (SELECT sc.idSC, sc.dtIns, nome, cognome, bb.idBl, bb.content, b.idBs, b.titleBis as title, bb.idMaster FROM segnalaCommB as sc, utenti as u, blogB as bb,
            bisogni as b
            WHERE sc.utente=u.idUs AND sc.commento=bb.idBl AND bb.bisogno=b.idBs) as t LEFT JOIN blogB ON blogB.idBl=t.idMaster
