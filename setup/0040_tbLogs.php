...
(
	...
	utente INT NOT NULL,
	dtStart DATETIME $dtNow NOT NULL,
	dtEnd DATETIME NULL,
...
if($_POST['resume'] === '1') {  //SQL SERVER
    if(stripos($_SESSION['ini']['dbms'], 'SQL Server') === 0){
        $resume = 'if exists(select TABLE_NAME from INFORMATION_SCHEMA.TABLES where TABLE_NAME = \'logs\') DROP TABLE logs;';
    }
    else if($_SESSION['ini']['dbms'] == 'My SQL'){
